 ...
 */
gulp.task('browser-sync', gulp.series('sass', 'jekyll-dev', function() {
  browserSync.init({
    server: '_site',
    port: 2610
  })
...
gulp.task('watch', function() {
  ...
  gulp.watch(['index.html', '_layouts/*.html', '_drafts/*', '_posts/*', '_pages/*', '_includes/*.html', '*.md', 'specials/*'], gulp.series('jekyll-rebuild'));
});
...
gulp.task('build', gulp.series('sass-prod', 'jekyll-prod'))
